...
<head>
    ...
    @guest
        <style>
            .bg-login-image {
                background: url({{asset('/storage/images/logo_color.png')}});
...
<div id="app">
            ...
            <footer class="sticky-footer bg-white">
                    <div class="container my-auto">
                        <div class="copyright text-center my-auto">
                            <span>2019 Copyright Brasil Brokers. Todos os direitos reservados</span>
                        </div>
                    </div>
            </footer>
        <!-- End of Footer -->
    ...
    <!-- End of Page Wrapper -->
    <!-- Fim de Usuário logado (autenticado) -->
    @endauth
    ...
    @guest
        ...
        <!-- Admin login -->
            @include('admin.login')
        <!-- End of Admin login -->
        <!-- Fim de Usuário visitante (não autenticado) -->
    @endguest
</div>
