            ...
            <div class="col-sm-12">
                <div class="card shadow">
                    <div class="card-header">
                        <h6 class="m-0 font-weight-bold text-primary">Alterar Comitente - Pessoa Jurídica</h6>
                    </div>
                    ...
                    <div class="card-body">
                        <form method="post" action="{{url('/admin/comitentes/update')}}" enctype="multipart/form-data">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" id="cpf_cnpj" name="cpf_cnpj" class="form-control @error('cpf_cnpj') is-invalid @enderror" value="{{ old('nome',$comitentes[0]->cpf_cnpj) }}">
