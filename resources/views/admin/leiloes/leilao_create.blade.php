...
@section('titulo','Cadastro Leilão')
            ...
            <div class="col-sm-12">
                <div class="card shadow">
                    <div class="card-header">
                        <h6 class="m-0 font-weight-bold text-primary">Cadastrar Leilão</h6>
                    </div>

                    <div class="card-body">
                        <form method="post" action="{{url('/admin/leiloes/store')}}"
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select name="comitente" id="comitente" class="custom-select form-control @error('comitente') is-invalid @enderror">
                                            ...
                                            @foreach($comitentes as $comitente)
                                                 <option value="{{$comitente->id}}" {{old('comitente') == $comitente->id ? 'selected' : ''}}>{{$comitente->nome}}</option>
                                            @endforeach
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select name="natureza" id="natureza"
                                            ...
                                            @foreach($naturezas as $natureza)
                                                <option value="{{$natureza->id}}" {{old('natureza') == $natureza->id ? 'selected' : ''}}>{{$natureza->nome}}</option>
                                            @endforeach
                                        </select>
                                    </div>
                                </div>
